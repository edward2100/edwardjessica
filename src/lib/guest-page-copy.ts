...
export const discoverMedanCopy: Record<Language, DiscoverMedanCopy> = {
  en: {
    ...
    introParagraphs: [
      "Welcome to Medan, a city with a rich culinary scene, shaped by Batak, Chinese, Minang, Malay, and Indian influences.",
      "From a morning bowl of Mie Pangsit to an evening feast of local street food, Medan offers something for every palate.",
      "As two people who grew up surrounded by Medan's incredible food culture, we're excited to share some of our favourite spots with you.",
      "Whether you're here for the wedding weekend or extending your stay, we hope you'll fall in love with the city one bite at a time.",
      "Some of our fondest memories are tied to the food in Medan. Whenever we are back home, Mie Pangsit, Sate Padang, and BPK (Babi Panggang Karo) are always at the top of our must-eat list.",
      "These are some of the flavors we grew up with, and we would love for you to experience them too.",
    ],
  ...
  id: {
    ...
    introParagraphs: [
      "Selamat datang di Medan, kota dengan dunia kuliner yang kaya, dibentuk oleh pengaruh Batak, Tionghoa, Minang, Melayu, dan India.",
      "Dari semangkuk Mie Pangsit di pagi hari hingga makanan kaki lima di malam hari, Medan punya banyak rasa untuk setiap selera.",
      "Sebagai dua orang yang tumbuh dikelilingi budaya makanan Medan yang luar biasa, kami senang bisa membagikan beberapa tempat favorit kami kepada Anda.",
      "Baik Anda datang untuk akhir pekan pernikahan atau memperpanjang perjalanan, kami berharap Anda ikut jatuh cinta pada kota ini satu suapan demi satu suapan.",
      "Beberapa kenangan paling hangat kami selalu terhubung dengan makanan di Medan. Setiap kali pulang, Mie Pangsit, Sate Padang, dan BPK (Babi Panggang Karo) selalu ada di daftar wajib makan kami.",
      "Inilah beberapa rasa yang menemani masa kecil kami, dan kami ingin Anda ikut menikmatinya.",
    ],
